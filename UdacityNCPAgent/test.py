...
from keras.layers import InputLayer, Conv2D,MaxPool2D,Dropout,Flatten,TimeDistributed,Dense,RNN,Activation,Reshape,Lambda,Activation,Permute
...
if __name__ == '__main__':
    ...
    #load model
    model = load_model(args.model,custom_objects={'LTCCell':LTCCell})
